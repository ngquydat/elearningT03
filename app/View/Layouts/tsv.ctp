...
<html>
<head>
	<?php echo $this->Html->charset("Shift-JIS"); ?>
	<title>
				...
				<ul class="fancyNav">
					<li id="home">
						...
						if($this->Session->read('role') == 'student'){
							echo $this->Html->link('ホーム', array('controller' => 'students','action' => 'home'),array("class"=>"homeIcon"));
						}
						if($this->Session->read('role') == 'teacher'){
							echo $this->Html->link('ホーム', array('controller' => 'teachers','action' => 'home'),array("class"=>"homeIcon"));
						}
						?>
