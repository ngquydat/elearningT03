...
<div class="content_2">
  ...
  <?php
  echo $this->Html->link($this->Form->button('タグ',array('type' => 'button','class' => "btn btn-default","id"=>"tag-submit-admin"),array("escape"=>false)),array('controller'=>'tags','action'=>'search_tag'),array("escape"=>false));
  ?>
