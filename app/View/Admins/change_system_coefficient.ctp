...
<div class="content_2">
	...
	<?php echo $this->Form->create("System",array("controller"=>"admins","action"=>"change_system_coefficient"));?>
	...
	echo $this->Form->button('変更34',array('class' => "btn btn-success btn-sm"));
	echo $this->Form->end();
	?>
