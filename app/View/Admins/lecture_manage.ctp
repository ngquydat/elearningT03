...
<div class="content_2">
  ...
  <div id="search-admin">
    ...
    <?php
    echo $this->Html->link($this->Form->button('タグ',array('type' => 'button','name'=>'search_tag','class' => "btn btn-default","id"=>"tag-submit-admin")),array('controller'=>'tags','action'=>'search_tag'),array("escape"=>false));
    ?>
  </div>
  <div>
